 ...
 * @author Denilson
 */
public class AnimalBuscar extends javax.swing.JInternalFrame {
     ...
     */
    public AnimalBuscar() {
        repositorio = RepositorioFactory.getAnimalRepo();
        animal = new Animal();
        initComponents();
    }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        List<Animal> resultado = repositorio.Buscar(animal);
        ...
        for(Animal a : resultado){
            ...
            linha.add(a.getNome());
            linha.add(a.getRaca());
            linha.add(a.getCliente());
            linha.add(a.getObservacoes());
    ...
    private void tblResultadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblResultadoMouseClicked
        ...
        Animal a = repositorio.Abrir(id);

        AnimalCadastro tela = new AnimalCadastro(a);
        this.getParent().add(tela);
        tela.setVisible(true);
